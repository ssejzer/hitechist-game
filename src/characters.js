...
export const CHARACTERS = [
  ...
  { id: "erez", name: "Erez", shirt: "#d9d9d0", skin: "#d6a071", hair: "#5d452c", beard: true, build: "slim" },
  { id: "luis", name: "Luis", shirt: "#bfb1b7", skin: "#b98060", hair: "#302d2c", short: true },
  { id: "nenad", name: "Nenad", shirt: "#34363e", skin: "#d8a383", hair: "#49382e", short: true, build: "broad", companion: "cat" },
  { id: "elad", name: "Elad", shirt: "#37607b", skin: "#ce967c", hair: "#252e38", beard: true, companion: "dog" },
  ...
  { id: "jason", name: "Jason", shirt: "#30394c", skin: "#d9ac89", hair: "#8d8274", beard: true, hat: "cap", smoking: true },
